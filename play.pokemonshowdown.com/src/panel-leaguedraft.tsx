...
class LeaguedraftRoom extends PSRoom {
...
class LeaguedraftPanel extends PSRoomPanel<LeaguedraftRoom> {
	static readonly id = 'leaguedraft';
	static readonly routes = ['leaguedraft'];
	static readonly Model = LeaguedraftRoom;
	static readonly icon = <i class="fa fa-pencil-square-o" aria-hidden></i>;
	static readonly title = 'League Draft';
	...
	renderFolderList() {
		...
		let renderedFormatFolders = [
			...
			<div class="folder"><button
				name="format" value="" data-selecttype="leaguedraft"
...
PS.addRoomType(LeaguedraftPanel);
