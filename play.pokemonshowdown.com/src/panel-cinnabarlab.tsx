...
class CinnabarlabRoom extends PSRoom {
...
class CinnabarlabPanel extends PSRoomPanel<CinnabarlabRoom> {
...
PS.roomTypes['cinnabarlab'] = {
	Model: CinnabarlabRoom,
	Component: CinnabarlabPanel,
	title: "Cinnabar Lab",
};
